...
D.1's read-only console (rev 2.26), and D.4 packaging/air-gap (rev 2.27)
landed on `feat/phase-d-administration`.
...
(everything lands here). Next is D.3; D.5 remains behind §11 item 4.
D.4's remaining release/operating evidence is CF-41. Gate B remains unrecorded.
