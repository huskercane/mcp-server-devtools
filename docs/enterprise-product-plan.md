...
| ADR-007 | Console technology | Static assets embedded in the binary (`rust-embed`, pinned), built from a small static export in `console/`; talks only to the admin API. | P | Keeps "one static binary, no runtime" true on-prem. |
