...
In the private `mcp-devtools-enterprise` checkout, build with
`cargo build --release --features console`. The Community crate has no console
feature. Run `mcp-devtools-enterprise`; set
