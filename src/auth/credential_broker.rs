//! Configuration/keychain and static adapters for the credential broker port.
...
use crate::ports::credential_broker::{CredentialBroker, ENVIRONMENT_KEY, UpstreamIdentityFuture};
